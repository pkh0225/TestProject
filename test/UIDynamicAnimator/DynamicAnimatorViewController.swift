...
class DynamicAnimatorViewController: UIViewController , RouterProtocol {
    ...
    override func viewDidLoad() {
        ...
        self.contentView.addSubview(blueBoxView!)
        self.contentView.addSubview(redBoxView!)
        self.contentView.addSubview(purpleBoxView!)
...
//        animator?.addBehavior(snap)
    ...
    @objc private func handlePanGesture(_ gesture: UIPanGestureRecognizer) {
        ...
        case .began:
            currentLocation = gesture.location(in: self.contentView)
            // 연결 점에 대한 오프셋 설정
